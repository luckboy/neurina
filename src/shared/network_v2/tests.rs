...
#[test]
fn test_network_v2_compute_computes_without_panic()
{
...
#[test]
fn test_network_v2_compute_computes_without_panic_for_50_columns()
{
    let mut iw_elems = vec![0.0f32; 200 * 100];
    xavier_init(iw_elems.as_mut_slice(), 100, 200);
    let iw = Matrix::new_with_elems(200, 100, iw_elems.as_slice());
...
#[test]
fn test_network_v2_backpropagate_backpropagates_without_panic()
{
    let mut iw_elems = vec![0.0f32; 200 * 100];
    xavier_init(iw_elems.as_mut_slice(), 100, 200);
    let iw = Matrix::new_with_elems(200, 100, iw_elems.as_slice());
...
#[test]
fn test_network_v2_backpropagate_backpropagates_without_panic_for_50_columns()
{
    let mut iw_elems = vec![0.0f32; 200 * 100];
    xavier_init(iw_elems.as_mut_slice(), 100, 200);
    let iw = Matrix::new_with_elems(200, 100, iw_elems.as_slice());
